...
fh = logging.FileHandler('DAG-UNLP_2020-09-01_2021-02-01_OT234-16.log')
...
with DAG(
    ...
    dag_id='DAG-UNLP_2020-09-01_2021-02-01_OT234-16',
    ...
    catchup=False
        ...
        extract_data = DummyOperator(
            ...
            # with open('/.../OT234-python/include/UNLP_2020-09-01_2021-02-01_OT234-16.sql', 'r') as file:
            #        query = file.read()
            # The connection used is setted at the Airflow UI in Admins/Connections and then called by id.
